...
# Anwendungswurzel. WICHTIG: seit dem Umzug nach core/ liegt diese Datei EINE Ebene
# tiefer — ohne das zweite `.parent` zeigte der Anker auf core/ statt auf app/, und
# weder die Lernkarten unter skills/ noch das Monolith-Regelwerk waeren auffindbar.
APP_ROOT = Path(__file__).resolve().parent.parent
MONOLITH_FILE = APP_ROOT / "tools" / "smart-planning" / "runtime" / "runtime-files" / "llm-validation-fix-rules.md"
...
def diagnose() -> dict:
    """Alle Karten-Diagnosen auf einmal (CLI: python -m core.rulebook_loader)."""
