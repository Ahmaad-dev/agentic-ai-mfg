...
class StorageManager:
    ...
    def __init__(self, base_path: Optional[str] = None):
        ...
        if base_path:
             ...
             # Dateirelativ statt arbeitsverzeichnisrelativ — vorher hing der Pfad davon ab,
             # aus welchem Ordner der Prozess gestartet wurde.
             # Im Container gibt es dieses Wurzelverzeichnis NICHT (die Anwendung liegt auf
             # /app). Das Image setzt deshalb LOCAL_STORAGE_PATH=/mnt/snapshots. Im Regelfall
             # laeuft dort ohnehin STORAGE_MODE=AZURE, aber der LOCAL-Fallback greift, sobald
             # die Verbindungszeichenfolge fehlt — und darf dann nicht ins Leere zeigen.
