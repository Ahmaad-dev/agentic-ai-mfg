...
| `REVALIDATION_UNVERIFIED` | historisch unzuverlässige Revalidierung |
...
> Die Beschriftung hieß bis zum 13.08.2026 „Angenommen ohne Änderung (AK2)". Die Nummer des
> Akzeptanzkriteriums ist eine Angabe aus DIESER Projektdokumentation und steht seither nicht
> mehr auf dem Bildschirm; die Konstante `AK2_TARGET` im Code trägt sie weiter.
